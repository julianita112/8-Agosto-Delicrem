...
export function Usuarios() {
  ...
  <label className="inline-flex relative items-center cursor-pointer">
    <input
      ...
      checked={user.activo}
      onChange={() => toggleActivo(user.id_usuario, user.activo)}
    />
    <div
      className={`relative inline-flex items-center h-5 w-10 bg-red-700 rounded-full transition-colors duration-300 ease-in-out peer-checked:bg-gradient-to-r peer-checked:from-[#255b47] peer-checked:to-[#6aa858] peer-hover:from-[#6b9561] peer-hover:to-[#426449]`}
    >
      <span
        className={`absolute block w-5 h-5 bg-white rounded-full shadow-md transform transition-transform duration-300 ease-in-out ${
